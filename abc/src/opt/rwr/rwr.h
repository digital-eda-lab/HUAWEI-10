...
typedef struct Rwr_Profile_t_ Rwr_Profile_t;
...
extern Rwr_Profile_t *   Rwr_ProfileStart( Abc_Ntk_t * pNtk, int nKeepMax, int fVerbose );
extern void              Rwr_ProfileStop( Rwr_Profile_t * p );
extern void              Rwr_ProfileFinalize( Rwr_Profile_t * p );
extern void              Rwr_ProfilePrint( Rwr_Profile_t * p );
extern int               Rwr_NodeRewriteProfile( Rwr_Man_t * p, Cut_Man_t * pManCut, Abc_Obj_t * pNode, int fUpdateLevel, int fUseZeros, int fPlaceEnable, Rwr_Profile_t * pProf );
