...
extern ABC_DLL int                Abc_NtkRewriteShare( Abc_Ntk_t * pNtk, int fUpdateLevel, int fUseZeros, int nTopK, int fUseShareSelect, int nShareDeltaMin, int nScoreMode, int nProfileBlocks, int nDestroyProbeThreshold, int fUseEqualGainShare, int fVerbose );
/*=== abcSat.c ==========================================================*/
